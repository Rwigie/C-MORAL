...
if __package__:
    from .rl import GRPOTrainer, GRPORolloutBuffer, AdaptiveKL
...
def configuration_plot(config) -> None:
    print_training_summary(config, algo="grpo", config_path=getattr(config, "config_path", None))
...
def main():
    ...
    _apply_model_grouped_paths(config, algo="grpo")
